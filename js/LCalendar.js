        ...
        bindEvent: function(type) {
            ...
            function popupDate(e) {
                ...
                _self.gearDate.innerHTML = '<div class="date_ctrl slideInUp">' +
                    '<div class="date_title">' +"<span class='year'>2017</span>年<span class='month'>6</span>月"+
                    '</div>' +
            ...
            function setDateGearTooth() {
                ...
                if (date_yy && date_yy.getAttribute("val")) {
                    ...
                    if (!isNaN(top)) {
                        ...
                        $('.date_title .year').text($($('.date_yy .tooth')[yyVal]).text());
                    } else {
                ...
                if (date_mm && date_mm.getAttribute("val")) {
                    ...
                    $('.date_title .month').text($($('.date_mm .tooth')[mmVal]).text());
            ...
            function finishMobileDate(e) {
                ...
                var d = (date_yy % passY + _self.minY) + "-" + date_mm ;
                if(new Date(d)-new Date()>0){
                	d=new Date().getFullYear()+"-"+(Number(new Date().getMonth())+1);
                }
                _self.trigger.value = d;
                _self.trigger.innerText = d;
